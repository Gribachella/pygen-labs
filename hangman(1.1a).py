...
def get_word(completed_words_list):
    ...
    скоросшиватель мультифора степлер хлебница противень скалка тёрка овощечистка секач""".upper().split()
    ...
    пылесос микроволновка духовка роутер колонка наушники фен вентилятор пароочиститель озонатор""".upper().split()
